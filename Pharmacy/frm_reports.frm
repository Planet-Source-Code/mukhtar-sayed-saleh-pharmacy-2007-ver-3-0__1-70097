...
End With
DataReport1.Sections(2).Controls("label1").Caption = "ÇáÃÏæíÉ ÇáãÊæİÑÉ İí ÇáÕíÏáíøÉ"
DataReport1.Sections(2).Controls("Label2").Caption = " ÊÇÑíÎ ÇÕÏÇÑ ÇáÊŞÑíÑ " & Format(Date, "Short Date") & " - " & " ÇáÓÇÚÉ : " & Time
DataReport1.Sections(5).Controls("Label3").Caption = " äÙÇã ÇáÕíÏáíøÉ 2007 -  " & mypharname

DataReport1.Caption = "ÊŞÑíÑ Úä ÇáÃÏæíÉ ÇáãÊæİÑÉ İí ÇáÕíÏáíøÉ"
DataReport1.Show
End Sub
...
End With
DataReport1.Sections(2).Controls("label1").Caption = "ÇáÃÏæíÉ ÇáäÇİĞÉ ãä ÇáÕíÏáíøÉ"
DataReport1.Sections(2).Controls("Label2").Caption = " ÊÇÑíÎ ÇÕÏÇÑ ÇáÊŞÑíÑ " & Format(Date, "Short Date") & " - " & " ÇáÓÇÚÉ : " & Time
DataReport1.Sections(5).Controls("Label3").Caption = " äÙÇã ÇáÕíÏáíøÉ 2007 -  " & mypharname

DataReport1.Caption = "ÊŞÑíÑ Úä ÇáÃÏæíÉ ÇáäÇİĞÉ ãä ÇáÕíÏáíøÉ"
DataReport1.Show

End Sub

Private Sub Command3_Click()
'ÍĞİ ÌãíÚ ÓÌáÇÊ ŞÇÚÏÉ ÇáÈíÇäÇÊ ÊÈÚ ÇáÃæíÉ ÇáİÇÓÏÉ
With Frm_Disactive
Dim X As Integer
On Error Resume Next
...
Next
End With
'ÊÚÈÆÉ ÇáŞÇÚÏÉ ÈÇáÃÏæíÉ ÇáİÇÓÏÉ İÚáÇğ
...
DataReport4.Sections(2).Controls("label1").Caption = "ÇáÃÏæíÉ ĞÇÊ ÇáÕáÇÍíøÉ ÇáãäÊåíÉ"
DataReport4.Sections(2).Controls("Label2").Caption = " ÊÇÑíÎ ÇÕÏÇÑ ÇáÊŞÑíÑ " & Format(Date, "Short Date") & " - " & " ÇáÓÇÚÉ : " & Time
DataReport4.Sections(5).Controls("Label3").Caption = " äÙÇã ÇáÕíÏáíøÉ 2007 -  " & mypharname
DataReport4.Caption = "ÊŞÑíÑ Úä ÇáÃÏæíÉ ÇáİÇÓÏÉ İí ÇáÕíÏáíøÉ"
DataReport4.Show
...
DataReport2.Sections(2).Controls("Label2").Caption = " ÊÇÑíÎ ÇÕÏÇÑ ÇáÊŞÑíÑ " & Format(Date, "Short Date") & " - " & " ÇáÓÇÚÉ : " & Time
DataReport2.Caption = "ÊŞÑíÑ Úä ÇÌãÇáí ãÈíÚÇÊ ÇáÕíÏáíøÉ"
