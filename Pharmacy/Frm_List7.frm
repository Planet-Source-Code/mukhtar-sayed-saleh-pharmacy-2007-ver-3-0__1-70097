...
Begin VB.Form Frm_List7 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   480
      OleObjectBlob   =   "Frm_List7.frx":0000
      Top             =   3000
   End
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "Frm_List7.frx":0234
      Height          =   4815
      Left            =   120
      OleObjectBlob   =   "Frm_List7.frx":0248
      TabIndex        =   3
      Top             =   720
      Width           =   3975
   End
End
Attribute VB_Name = "Frm_List7"
...
Frm_AddDoa.Text8.Text = Text1.Text
selmord = Text1.Text
Unload Me
End Sub
...
With Data1.Recordset
    ...
    .MoveFirst
                .FindFirst "[morname] like '" & txtsearch.Text & "*'"
    
    If .NoMatch = True Then
        MsgBox "ÇáãæÑøÏ ÛíÑ ãæÌæÏ", vbExclamation, "äÙÇã ÇáÕíÏáíøÉ 2007"
