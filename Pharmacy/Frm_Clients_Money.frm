...
Else
MsgBox "«·—Ã«¡  ÕœÌœ «·„»·€ «·„ÿ·Ê»", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
End If
...
If Text3.Text = "" Then
MsgBox "«·—Ã«¡  ÕœÌœ «·„»·€", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

Dim mok
mok = MsgBox(" Â· √‰  „ √ﬂœ √‰ﬂ  —Ìœ Õ–› «·„»·€ „‰ œ› — Õ”«»«  " & Text1.Text, 64 + vbYesNo, "‰Ÿ«„ «·’Ìœ·Ì¯…")
If mok = vbYes Then
...
Data2.Refresh
DBGrid2.Caption = " œ› — Õ”«» " & Text1.Text
DBGrid2.Refresh
DBGrid2.ReBind
...
End If
If CDbl(Text9.Text) > CDbl(Text8.Text) Then
Text10.Text = " œ«∆‰ ⁄·Ì‰« »„»·€ " & (CDbl(Text9.Text) - CDbl(Text8.Text))
Text10.BackColor = &HC0C0FF
End If
If CDbl(Text9.Text) < CDbl(Text8.Text) Then
Text10.Text = " „œÌ‰ ·‰« »„»·€ " & (CDbl(Text8.Text) - CDbl(Text9.Text))
