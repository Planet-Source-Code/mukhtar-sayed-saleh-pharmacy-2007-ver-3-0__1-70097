...
.Data1.Refresh
   If .Text1.Text <> "" Then
      Dim mok
      mok = MsgBox("«·œÊ«¡ «·„Õœœ Ì⁄ »— „‰ ÷„‰ «·√œÊÌ… –«  «·’·«ÕÌ¯… «·„‰ ÂÌ… , Â·  —€» ›Ì «·«” „—«— »«·„»Ì⁄ ⁄·Ï √Ì¯… Õ«· ø", vbYesNo + vbInformation, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007")
      If mok = vbNo Then
        MsgBox " „ ≈·€«¡ «·„»Ì⁄ ·Â–« «·œÊ«¡ »”»» «‰ Â«¡ ’·«ÕÌ¯ Â »‰Ã«Õ", vbInformation, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
        Exit Sub
      End If
   End If
 End With
...
With Data1.Recordset
    ...
    If .NoMatch = True Then
        MsgBox "«·œÊ«¡ €Ì— „ÊÃÊœ", vbExclamation, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
