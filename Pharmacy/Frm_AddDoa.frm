...
MsgBox "«·—Ã«¡ «· Õﬁﬁ „‰ ≈œŒ«· ﬂ«›… «·ÕﬁÊ· «·„ÿ·Ê»…", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If

If IsNumeric(Text4.Text) = False Then
MsgBox "”⁄— «·ﬁÿ⁄… «·Ê«Õœ… ··⁄„Ê„ ÌÃ» √‰ ÌﬂÊ‰ —ﬁ„«", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

If IsNumeric(Text6.Text) = False Then
MsgBox "”⁄— «·ﬁÿ⁄… «·Ê«Õœ… ··’Ìœ·Ì ÌÃ» √‰ ÌﬂÊ‰ —ﬁ„«", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

If IsNumeric(Text5.Text) = False Then
MsgBox "⁄œœ «·ﬁÿ⁄ «·„ Ê›¯—… ÌÃ» √‰ ÌﬂÊ‰ —ﬁ„«", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

If IsDate(Text10.Text) = False Then
MsgBox "≈‰ «· ⁄»Ì— «·„ÊÃÊœ ›Ì Õﬁ·  «—ÌŒ «·›⁄«·Ì¯… ·Ì”  «—ÌŒ« «·—Ã«¡ «· Õﬁﬁ „‰ «·√„—", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

If CDbl(Text6.Text) > CDbl(Text4.Text) Then
MsgBox "”⁄— «·œÊ«¡ ··⁄„Ê„ ÌÃ» √‰ ÌﬂÊ‰ √ﬂ»— „‰ ”⁄—Â ··’Ìœ·Ì", vbInformation, " „ ≈Ìﬁ«›  ”ÃÌ· «·œÊ«¡"
Exit Sub
End If

If storecommand1 = "addnew" Then

'«· Õﬁﬁ „‰ ⁄œ„  ‘«»Â ﬂÊœ «·œÊ«¡ „⁄ œÊ«¡ À«‰Ì
  With frm_store.Data1.Recordset
  On Error Resume Next
      .MoveFirst
      .FindFirst "[docode] like '" & CStr(Text3.Text) & "*'"
    If .NoMatch = False Then
      MsgBox "ÌÊÃœ œÊ«¡ ¬Œ— ·Â ‰›” «·ﬂÊœ «·—Ã«¡  €ÌÌ— ﬂÊœ «·œÊ«¡ Ê «·„Õ«Ê·… ·«Õﬁ«", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
      Exit Sub
    End If
  End With
