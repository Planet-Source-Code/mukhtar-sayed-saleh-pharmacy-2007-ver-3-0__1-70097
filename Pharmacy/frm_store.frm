...
End With
DataReport3.Caption = "„⁄«Ì‰… ﬁ»· ÿ»«⁄… «··’«ﬁ« "

DataReport3.Show
Else
MsgBox "«·—Ã«¡  ÕœÌœ «·œÊ«¡ «·„ÿ·Ê»", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
...
If Text1.Text = "" Then
MsgBox "«·—Ã«¡  ÕœÌœ «·œÊ«¡", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

Dim mok
mok = MsgBox(" Â· √‰  „ √ﬂœ √‰ﬂ  —Ìœ Õ–› œÊ«¡ " & Text2.Text & " „ı‰ Ã ‘—ﬂ… " & Text1.Text, 64 + vbYesNo, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007")
If mok = vbYes Then
...
If Text5.Text = "" Then
MsgBox "·« ÌÊÃœ √Ì √œÊÌ… ›Ì «·„” Êœ⁄", 64, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
Else
 Dim I As Long
 ' Õ÷Ì— «·»—ÊÃ—” »«—
...
If Frm_Naf.Data1.Recordset.RecordCount > Int(0) Then
 ...
 StayOnTop Frm_Naf
 Else
  MsgBox "·« ÌÊÃœ √Ì √œÊÌ… ‰«›–…", 64, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If
End If
...
If Frm_Disactive.Data1.Recordset.RecordCount > Int(0) Then
 ...
 Else
  MsgBox "·« ÌÊÃœ √Ì √œÊÌ… ›«”œ…", 64, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If
End If
