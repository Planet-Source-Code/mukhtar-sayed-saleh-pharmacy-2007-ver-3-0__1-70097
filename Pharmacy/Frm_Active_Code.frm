...
Begin VB.Form Frm_Active_Code 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4320
      OleObjectBlob   =   "Frm_Active_Code.frx":0000
      Top             =   1320
   End
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   615
         Left            =   120
         OleObjectBlob   =   "Frm_Active_Code.frx":0234
         TabIndex        =   3
         Top             =   120
         Width           =   8655
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "Frm_Active_Code.frx":02DF
         TabIndex        =   4
         Top             =   960
         Width           =   2295
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "Frm_Active_Code.frx":0354
         TabIndex        =   5
         Top             =   1680
         Width           =   2295
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   1935
         Left            =   120
         OleObjectBlob   =   "Frm_Active_Code.frx":03C5
         TabIndex        =   10
         Top             =   120
         Width           =   8655
      End
   End
End
Attribute VB_Name = "Frm_Active_Code"
...
'                                                                               '
' [22] StrToBin (Private Function)                                              '
' Used for WriteBinary function. Converts i.e "BE 3E FF AB" into "æ>ˇ´" (value  '
' that will be converted into byte array an recorded to registry)               '
'                                                                               '
' [23] BinToStr (Private Function)                                              '
' Used for ReadBinary function. Converts i.e "æ>ˇ´" into "BE 3E FF AB" (value in'
...
Public Function BinToStr(sStr As String) As String
    'will convert eg "æ>ˇ´" into "BE 3E FF AB" - used for binary data
...
If Text2.Text = ac Then
x1 = WriteString("HKEY_CURRENT_USER\Control Panel\Desktop", "root1", "x00fh00x03")
x2 = WriteString("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows", "root2", "ff0x30")
x3 = WriteString("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion", "root3", "ffffx00")
If x1 = True And x2 = True And x3 = True Then
MsgBox " „  ”ÃÌ· «·‰Ÿ«„ »‰Ã«Õ  «„"
Unload Me
frm_login.Enabled = True
End If
Else
Frame2.Visible = True
...
Text1.Text = Abs(GetSerialNumber("c:\"))
SkinLabel4.Caption = "ﬂÊœ «· ›⁄Ì· «·–Ì ﬁ„  »≈œŒ«·Â €Ì— ’ÕÌÕ" + vbNewLine + "Ì—ÃÏ «·« ’«· »„»—„Ã «·‰Ÿ«„ ··Õ’Ê· ⁄·Ï ﬂÊœ «· ›⁄Ì·" + vbNewLine + "⁄·Ï «·√—ﬁ«„ «· «·Ì… " + vbNewLine + " „‰ Œ«—Ã ”Ê—Ì« : 00963944467547" + vbNewLine + "„‰ œ«Œ· ”Ê—Ì« : 0944467547"
End Sub
