...
MsgBox "«·—Ã«¡ «œŒ«· «· Ê«—ÌŒ »‘ﬂ· ’ÕÌÕ", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
...
MsgBox "ÌÃ» √‰ ÌﬂÊ‰  «—ÌŒ «·≈‰ Â«¡ »⁄œ  «—ÌŒ «·»œ¡", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If
'»œ«Ì… «· ÿ»Ìﬁ
...
End With
DataReport2.Sections(2).Controls("label1").Caption = "„»Ì⁄«  «·’Ìœ·Ì¯… »Ì‰ " & Format(Text1.Text, "Short Date") & " Ê " & Format(Text2.Text, "Short Date")
DataReport2.Sections(2).Controls("Label2").Caption = "  «—ÌŒ «’œ«— «· ﬁ—Ì— " & Format(Date, "Short Date") & " - " & " «·”«⁄… : " & Time
DataReport2.Caption = " ﬁ—Ì— ⁄‰ „»Ì⁄«  «·’Ìœ·Ì¯… »Ì‰ " & Format(Text1.Text, "Short Date") & " Ê " & Format(Text2.Text, "Short Date")
'Õ”«» „Ã„Ê⁄ «Ã„«·Ì «·„»Ì⁄« 
Dim I As Long
Dim S As Double
S = CDbl(0)
...
DataReport2.Sections(5).Controls("Label6").Caption = " ‰Ÿ«„ «·’Ìœ·Ì¯… 2007 -  " & mypharname
