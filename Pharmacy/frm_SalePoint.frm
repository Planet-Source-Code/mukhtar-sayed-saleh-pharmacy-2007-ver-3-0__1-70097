...
MsgBox "«·—Ã«¡  ÕœÌœ ⁄œœ «·ﬁÿ⁄ «·„»«⁄…", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If
...
If Text5.Text = "" Then
MsgBox "«·—Ã«¡  ÕœÌœ «·œÊ«¡ «·„—«œ ≈‰ﬁ«’Â", 16, "‰Ÿ«„ «·’Ìœ·Ì… 2007"
Exit Sub
End If

Dim mok
mok = MsgBox(" Â· √‰  „ √ﬂœ √‰ﬂ  —Ìœ ≈‰ﬁ«’ «·ﬂ„Ì¯… ø ", 64 + vbYesNo, "‰Ÿ«„ «·’Ìœ·Ì¯…")
If mok = vbYes Then
'Ã„⁄ «·ﬂ„Ì¯… „⁄ «·„” Êœ⁄
With frm_store
...
Dim mok
mok = MsgBox("Â· √‰  „ √ﬂ¯œ ø", 64 + vbYesNo, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007")
If mok = vbYes Then
Dim I As Integer
On Error Resume Next
...
If IsNumeric(Text3.Text) = True Then
 ...
 MsgBox "⁄œœ «·ﬁÿ⁄ «·„ Ê›—… " & selcount & " ›ﬁÿ ", 64, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
 Text3.Text = "0"
 End If
Text4.Text = (CDbl(CInt(Text3.Text)) * CDbl(selcash))
Me.refreshall
Else
MsgBox "«œŒ· «—ﬁ«„ ’ÕÌÕ… ›ﬁÿ", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Text3.Text = "0"
Exit Sub
End If
End If
