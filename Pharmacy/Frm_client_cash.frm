...
If Text1.Text = "" Then
MsgBox "«·—Ã«¡  ÕœÌœ «·⁄„Ì· «·„ÿ·Ê»", 16, "‰Ÿ«„ «·’Ìœ·Ì¯… 2007"
Exit Sub
End If
'›· —… √Ê· ‘Ì —’Ìœ «·⁄„Ì·
...
.refreshall
'„·∆ «· ﬁ—Ì—
DataReport5.Sections(2).Controls("label1").Caption = " Õ”«» «·⁄„Ì· : " & Text1.Text
DataReport5.Sections(2).Controls("Label2").Caption = "  «—ÌŒ «’œ«— «· ﬁ—Ì— " & Format(Date, "Short Date") & " - " & " «·”«⁄… : " & Time
...
DataReport5.Sections("section5").Controls("Label9").Caption = " ‰Ÿ«„ «·’Ìœ·Ì¯… 2007 -  " & mypharname
End With
